...
namespace LeaseIt.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = Input.Email, Email = Input.Email, FirstName= Input.FirstName,
                    LastName = Input.LastName, StreetAdress=Input.StreetAdress, City= Input.City, Province= Input.Province,
                    ZipCode=Input.ZipCode, Country=Input.Country};
